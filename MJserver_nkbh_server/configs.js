...
var TIMEMANAGERSVR_IP = '60.205.203.40' 
var TIMEMANAGERSVR_PORT = 9997
...
exports.account_server = function(){
	return {
		...
		VERSION:'20170901',
		APP_WEB:'http://ddz5.zz.gongyou.co:9916/download/index.html'
	};
};
...
exports.game_server = function(){
	return {
		...
		CLIENT_IP:HALL_IP,
		CLIENT_PORT:10000,
		TMS_IP:TIMEMANAGERSVR_IP,
		TMS_PORT:TIMEMANAGERSVR_PORT,
	};
};