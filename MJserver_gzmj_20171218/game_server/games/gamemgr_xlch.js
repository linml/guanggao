...
function checkCanHu(game, seatData, targetPai) {
    ...
    //var pattern = mjutils.checkCanHu({},seatData);//错误
    ...
    if (pattern != null) {
        ...
        if (seatData.tingInfo.isZiMo) {//如果是自摸
...
function doGameOver(roomInfo, forceEnd) {
    ...
    if (game != null) {
        ...
        //一炮多响者当庄。
        if (game.yiPaoDuoXiangSeat >= 0) {
            roomInfo.nextButton = game.yiPaoDuoXiangSeat;
        }
        //最先胡牌者当庄。
            ...
            //流局，下家当庄。
            roomInfo.nextButton = (game.turn + 1) % game.gameSeats.length;
        }
